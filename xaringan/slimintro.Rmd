---
  title: "SLiMulating Evolution with SLiM"
  author: "Nick O'Brien <br><span style = 'font-size: 75%;'>University of Queensland<br>School of Biological Sciences + ARC Centre of Excellence for Plant Success in Nature and Agriculture<br>  Ortiz-Barrientos Lab</span>"
  date: '`r Sys.Date()`<br><br>`r shiny::icon("envelope")` [n.obrien@uq.edu.au](mailto:n.obrien@uq.edu.au)<br>`r shiny::icon("twitter")`  [stochasnick](https://twitter.com/stochasnick)<br> `r shiny::icon("github")` [nobrien97](https://github.com/nobrien97)'
  output:
    xaringan::moon_reader:
      css: ["metropolis", "include/custom.css", "include/2col.css"]
      lib_dir: libs
      nature:
